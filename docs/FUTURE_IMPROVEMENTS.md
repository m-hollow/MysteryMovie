...
Technical improvements and refactoring opportunities that aren't bugs but would improve code quality, performance, maintainability, and developer experience. Each item has a detailed plan in [`plans/improvements/`](plans/improvements/).
...
- **Plan**: [docs/plans/improvements/imp-01-split-views.md](plans/improvements/imp-01-split-views.md)
...
- **Plan**: [docs/plans/improvements/imp-02-extract-point-calculation.md](plans/improvements/imp-02-extract-point-calculation.md)
...
- **Plan**: [docs/plans/improvements/imp-03-replace-session-state.md](plans/improvements/imp-03-replace-session-state.md)
...
- **Plan**: [docs/plans/improvements/imp-04-add-test-suite.md](plans/improvements/imp-04-add-test-suite.md)
...
- **Plan**: [docs/plans/improvements/imp-05-optimize-queries.md](plans/improvements/imp-05-optimize-queries.md)
...
- **Plan**: [docs/plans/improvements/imp-06-database-annotations.md](plans/improvements/imp-06-database-annotations.md)
...
- **Plan**: [docs/plans/improvements/imp-07-implement-logging.md](plans/improvements/imp-07-implement-logging.md)
...
- **Plan**: [docs/plans/improvements/imp-08-security-hardening.md](plans/improvements/imp-08-security-hardening.md)
...
- **Plan**: [docs/plans/improvements/imp-13-dockerize-dev-environment.md](plans/improvements/imp-13-dockerize-dev-environment.md)
...
- **Plan**: [docs/plans/improvements/imp-09-add-ci-cd.md](plans/improvements/imp-09-add-ci-cd.md)
...
- **Plan**: [docs/plans/improvements/imp-10-upgrade-django.md](plans/improvements/imp-10-upgrade-django.md)
...
- **Plan**: [docs/plans/improvements/imp-14-migrate-to-postgresql.md](plans/improvements/imp-14-migrate-to-postgresql.md)
...
- **Plan**: [docs/plans/improvements/imp-11-database-constraints.md](plans/improvements/imp-11-database-constraints.md)
...
- **Plan**: [docs/plans/improvements/imp-12-cleanup-dead-code.md](plans/improvements/imp-12-cleanup-dead-code.md)
