...
New functionality that would extend the Mystery Movie Club experience. Each idea has a detailed plan in [`docs/plans/features/`](docs/plans/features/).
...
- **Plan**: [docs/plans/features/feat-01-movie-database-integration.md](docs/plans/features/feat-01-movie-database-integration.md)
...
- **Plan**: [docs/plans/features/feat-02-streaming-availability.md](docs/plans/features/feat-02-streaming-availability.md)
...
- **Plan**: [docs/plans/features/feat-03-advanced-statistics.md](docs/plans/features/feat-03-advanced-statistics.md)
...
- **Plan**: [docs/plans/features/feat-04-round-analytics.md](docs/plans/features/feat-04-round-analytics.md)
...
- **Plan**: [docs/plans/features/feat-05-historical-greatest-hits.md](docs/plans/features/feat-05-historical-greatest-hits.md)
...
- **Plan**: [docs/plans/features/feat-06-achievement-badges.md](docs/plans/features/feat-06-achievement-badges.md)
...
- **Plan**: [docs/plans/features/feat-07-custom-scoring.md](docs/plans/features/feat-07-custom-scoring.md)
...
- **Plan**: [docs/plans/features/feat-08-notifications.md](docs/plans/features/feat-08-notifications.md)
...
- **Plan**: [docs/plans/features/feat-09-comments-discussion.md](docs/plans/features/feat-09-comments-discussion.md)
...
- **Plan**: [docs/plans/features/feat-10-mobile-optimization.md](docs/plans/features/feat-10-mobile-optimization.md)
...
- **Plan**: [docs/plans/features/feat-11-dark-mode.md](docs/plans/features/feat-11-dark-mode.md)
...
- **Plan**: [docs/plans/features/feat-12-poster-card-layout.md](docs/plans/features/feat-12-poster-card-layout.md)
...
- **Plan**: [docs/plans/features/feat-13-game-variants.md](docs/plans/features/feat-13-game-variants.md)
...
- **Plan**: [docs/plans/features/feat-14-yearly-recap.md](docs/plans/features/feat-14-yearly-recap.md)
...
- **Plan**: [docs/plans/features/feat-15-chat-bot-integration.md](docs/plans/features/feat-15-chat-bot-integration.md)
...
- **Plan**: [docs/plans/features/feat-16-rest-api.md](docs/plans/features/feat-16-rest-api.md)
