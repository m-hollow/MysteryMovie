...
Bugs discovered through code analysis, organized by severity. Each bug has a detailed plan file in [`docs/plans/bugs/`](docs/plans/bugs/).
...
- **Plan**: [docs/plans/bugs/bug-01-commit-user-round-unreachable-code.md](docs/plans/bugs/bug-01-commit-user-round-unreachable-code.md)
...
- **Plan**: [docs/plans/bugs/bug-02-unsafe-profile-pic-upload.md](docs/plans/bugs/bug-02-unsafe-profile-pic-upload.md)
...
- **Plan**: [docs/plans/bugs/bug-03-unsafe-movie-image-upload.md](docs/plans/bugs/bug-03-unsafe-movie-image-upload.md)
...
- **Plan**: [docs/plans/bugs/bug-04-bare-except-clauses.md](docs/plans/bugs/bug-04-bare-except-clauses.md)
...
- **Plan**: [docs/plans/bugs/bug-05-foreignkey-default-mismatch.md](docs/plans/bugs/bug-05-foreignkey-default-mismatch.md)
...
- **Plan**: [docs/plans/bugs/bug-06-unsafe-username-icontains.md](docs/plans/bugs/bug-06-unsafe-username-icontains.md)
...
- **Plan**: [docs/plans/bugs/bug-07-undefined-idx-partystate.md](docs/plans/bugs/bug-07-undefined-idx-partystate.md)
...
- **Plan**: [docs/plans/bugs/bug-08-keyerror-chosen-by-none.md](docs/plans/bugs/bug-08-keyerror-chosen-by-none.md)
...
- **Plan**: [docs/plans/bugs/bug-09-stale-date-defaults.md](docs/plans/bugs/bug-09-stale-date-defaults.md)
...
- **Plan**: [docs/plans/bugs/bug-10-multiple-active-rounds.md](docs/plans/bugs/bug-10-multiple-active-rounds.md)
...
- **Plan**: [docs/plans/bugs/bug-11-missing-csrf-ajax.md](docs/plans/bugs/bug-11-missing-csrf-ajax.md)
...
- **Plan**: [docs/plans/bugs/bug-12-missing-self-parameter.md](docs/plans/bugs/bug-12-missing-self-parameter.md)
...
- **Plan**: [docs/plans/bugs/bug-13-hardcoded-success-url.md](docs/plans/bugs/bug-13-hardcoded-success-url.md)
...
- **Plan**: [docs/plans/bugs/bug-14-n-plus-1-results-party.md](docs/plans/bugs/bug-14-n-plus-1-results-party.md)
...
- **Plan**: [docs/plans/bugs/bug-15-missing-security-headers.md](docs/plans/bugs/bug-15-missing-security-headers.md)
...
- **Plan**: [docs/plans/bugs/bug-16-index-out-of-bounds-party.md](docs/plans/bugs/bug-16-index-out-of-bounds-party.md)
...
- **Plan**: [docs/plans/bugs/bug-17-manage-py-settings.md](docs/plans/bugs/bug-17-manage-py-settings.md)
...
- **Plan**: [docs/plans/bugs/bug-18-print-statements.md](docs/plans/bugs/bug-18-print-statements.md)
...
- **Plan**: [docs/plans/bugs/bug-19-python-sorting.md](docs/plans/bugs/bug-19-python-sorting.md)
...
- **Plan**: [docs/plans/bugs/bug-20-multiple-movie-choosers.md](docs/plans/bugs/bug-20-multiple-movie-choosers.md)
...
- **Plan**: [docs/plans/bugs/bug-21-commented-out-code.md](docs/plans/bugs/bug-21-commented-out-code.md)
